...
// Inject HTML Frame
$("body").append('<div class="lumos-container"><div class="lumos-alt-text"></div><img class="lumos-img" src="" /><svg version="1.1" class="lumos-prev" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 306 306" xml:space="preserve"><g><g id="chevron-right"><polygon points="173,25 173,29 62,153 170,266 170,270 58,153" /></g></g></svg><svg version="1.1" class="lumos-next" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 306 306" xml:space="preserve"><g><g id="chevron-right"><polygon points="58,25 58.65,32 170,153 58.65,270.3 59,277 177.35,153" /></g></g></svg><svg version="1.1" class="lumos-close" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve"><path fill="#919692" d="M512,51.75L460.25,0L256,204.25L51.75,0L0,51.75L204.25,256L0,460.25L51.75,512L256,307.75L460.25,512L512,460.25 L307.75,256L512,51.75z" /></svg><div class="lumos-name"></div><div class="spinner"><div class="rect1"></div><div class="rect2"></div><div class="rect3"></div><div class="rect4"></div><div class="rect5"></div></div></div>');
...
function getNextImage(direction) {
    ...
    for (var i = 0; i < currentGallery.length; i++) {
        ...
        if (currentGallery[i].getAttribute("href") == currentImage) {
            if (direction == "next") { i++; }
            if (direction == "prev") { i--; }
            if (i >= 0 && i < currentGallery.length) {
    ...
    if (nextImage != null && nextImage.getAttribute("data-lumos") != currentGalleryName) {
        return currentImage;
    }
    if (typeof nextImage == "undefined" || nextImage == null) {
        if (direction == "prev")
            return currentGallery[0].getAttribute("href");

        if (direction == "next")
            return currentGallery[currentGallery.length-1].getAttribute("href");
